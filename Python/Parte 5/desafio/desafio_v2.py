...
# Define o caminho raiz do script atual
ROOT_PATH = Path(__file__).parent

# Classe para iterar sobre uma lista de contas bancárias
...
# Classe representando um cliente do banco
class Cliente:
...
# Classe representando uma pessoa física que é cliente do banco
...
# Classe base representando uma conta bancária
class Conta:
...
# Classe representando uma conta corrente com limites específicos
...
# Classe abstrata representando uma transação bancária
class Transacao(ABC):
    @property
    @abstractproperty
    def valor(self):
...
# Decorador para logar transações em um arquivo
